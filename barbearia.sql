...
CREATE TABLE `barbearias` (
  ...
  KEY `id_dono` (`id_dono`),
  CONSTRAINT `barbearias_ibfk_1` FOREIGN KEY (`id_dono`) REFERENCES `donos` (`id_dono`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cliente` VALUES (1,'Felipe','Ortigoza','felipe@gmail.com','14998405428','202cb962ac59075b964b07152d234b70');
...
-- Dump completed on 2024-11-01  9:21:00
