...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$erro) {
        ...
        $msg[6] = "<div style='color: green; font-weight: bold;'>Cliente cadastrado com sucesso!</div>"; 
    }
}
?>
    ...
    <div class="container">
        ...
        <div class="form">
            <form action="#" method="post" id="cadastroForm">
                ...
                <div style="margin-top: -3%">Já possui uma conta?<a id="entrar" href="../views/login.php"> Entrar</a></div>
